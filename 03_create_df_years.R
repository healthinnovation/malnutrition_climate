...
malnutrition_14 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, 
            ...
            mean.0_EVI, mean.1_EVI, mean.2_EVI,mean.3_EVI, mean.4_EVI, 
            mean.5_EVI, mean.6_EVI, mean.7_EVI, mean.8_EVI,mean.9_EVI, 
            mean.10_EVI, mean.11_EVI,
...
count_consecutive_ones <- function(x) {
  ...
  sum(consecutivos$lengths[consecutivos$values == 1]) 
}
...
cons <- count_consecutive_groups(lista)
...
malnutrition_14_new <- malnutrition_14_trans[, 92:length(names(malnutrition_14_trans))]
...
malnutrition_15 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, region, conglomerado,
            ...
            mean.12_NDVI, mean.13_NDVI, mean.14_NDVI,mean.15_NDVI, mean.16_NDVI, mean.17_NDVI, 
            mean.18_NDVI, mean.19_NDVI, mean.20_NDVI,mean.21_NDVI, mean.22_NDVI, mean.23_NDVI,
            
            mean.201501_pr,mean.201502_pr,mean.201503_pr,mean.201504_pr,mean.201505_pr,mean.201506_pr,
            mean.201507_pr,mean.201508_pr,mean.201509_pr,mean.201510_pr,mean.201511_pr,mean.201512_pr,
            
            mean.201501_tmmx,mean.201502_tmmx,mean.201503_tmmx,mean.201504_tmmx,mean.201505_tmmx,mean.201506_tmmx,
            mean.201507_tmmx,mean.201508_tmmx,mean.201509_tmmx,mean.201510_tmmx,mean.201511_tmmx,mean.201512_tmmx,
            
            mean.201501_tmmn,mean.201502_tmmn,mean.201503_tmmn,mean.201504_tmmn,mean.201505_tmmn,mean.201506_tmmn,
            mean.201507_tmmn,mean.201508_tmmn,mean.201509_tmmn,mean.201510_tmmn,mean.201511_tmmn,mean.201512_tmmn)
...
for (i in 1:length(congs)) {
  ...
  umbrales_region$veg_low_10[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                 names(data_filtered))], 0.10, na.rm = TRUE)
  umbrales_region$veg_high_90[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                  names(data_filtered))], 0.90, na.rm =TRUE)
  umbrales_region$veg_low_5[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                names(data_filtered))], 0.05, na.rm = TRUE)
  umbrales_region$veg_high_95[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                  names(data_filtered))], 0.95, na.rm =TRUE)
  umbrales_region$veg_low_1[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                names(data_filtered))], 0.01, na.rm = TRUE)
  umbrales_region$veg_high_99[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", 
                                                                  names(data_filtered))], 0.99, na.rm =TRUE)
  
  # Precipitacion
  
  
  umbrales_region$prec_low_10[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                  names(data_filtered))], 0.10, na.rm =TRUE)
  umbrales_region$prec_high_90[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                   names(data_filtered))], 0.90, na.rm =TRUE)
  umbrales_region$prec_low_5[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                 names(data_filtered))], 0.05, na.rm =TRUE)
  umbrales_region$prec_high_95[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                   names(data_filtered))], 0.95, na.rm =TRUE)
  umbrales_region$prec_low_1[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                 names(data_filtered))], 0.01, na.rm =TRUE)
  umbrales_region$prec_high_99[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", 
                                                                   names(data_filtered))], 0.99, na.rm =TRUE)
  
  
  # Temperatura maxima
  
  umbrales_region$tmax_low_10[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                  names(data_filtered))], 0.10, na.rm =TRUE)
  umbrales_region$tmax_high_90[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                   names(data_filtered))], 0.90, na.rm =TRUE)
  umbrales_region$tmax_low_5[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                 names(data_filtered))], 0.05, na.rm =TRUE)
  umbrales_region$tmax_high_95[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                   names(data_filtered))], 0.95, na.rm =TRUE)
  umbrales_region$tmax_low_1[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                 names(data_filtered))], 0.01, na.rm =TRUE)
  umbrales_region$tmax_high_99[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", 
                                                                   names(data_filtered))], 0.99, na.rm =TRUE)
  
  # Temperatura minima
  
  umbrales_region$tmin_low_10[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                  names(data_filtered))], 0.10, na.rm =TRUE)
  umbrales_region$tmin_high_90[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                   names(data_filtered))], 0.90, na.rm =TRUE)
  umbrales_region$tmin_low_5[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                 names(data_filtered))], 0.05, na.rm =TRUE)
  umbrales_region$tmin_high_95[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                   names(data_filtered))], 0.95, na.rm =TRUE)
  umbrales_region$tmin_low_1[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                 names(data_filtered))], 0.01, na.rm =TRUE)
  umbrales_region$tmin_high_99[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", 
                                                                   names(data_filtered))], 0.99, na.rm =TRUE)
}
...
malnutrition_15_thresholded <- malnutrition_15_with_thresholds %>%
  
  mutate(
    
    #NDVI
    NDVI_high_90 = rowSums(sapply(select(., contains("NDVI")), function(x) x > veg_high_90)),
    NDVI_low_10 = rowSums(sapply(select(., contains("NDVI")), function(x) x < veg_low_10)),
    NDVI_high_95 = rowSums(sapply(select(., contains("NDVI")), function(x) x > veg_high_95)),
    NDVI_low_5 = rowSums(sapply(select(., contains("NDVI")), function(x) x < veg_low_5)),
    NDVI_high_99 = rowSums(sapply(select(., contains("NDVI")), function(x) x > veg_high_99)),
    NDVI_low_1 = rowSums(sapply(select(., contains("NDVI")), function(x) x < veg_low_1)),
    NDVI_range = apply(select(., contains("NDVI")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    
    NDVI_mean = apply(select(., contains("NDVI")), 1, mean, na.rm = TRUE),
    NDVI_sd = apply(select(., contains("NDVI")), 1, sd, na.rm = TRUE),
    NDVI_median = apply(select(., contains("NDVI")), 1, median, na.rm = TRUE),
    NDVI_IQR = apply(select(., contains("NDVI")), 1, IQR, na.rm = TRUE),
    NDVI_last_months = rowMeans(select(., c("mean.17_NDVI", "mean.18_NDVI", "mean.19_NDVI"))),
    NDVI_first_months = rowMeans(select(., c("mean.12_NDVI", "mean.13_NDVI", "mean.14_NDVI"))),
    NDVI_seasonal_diff = NDVI_last_months - NDVI_first_months,
    
    
    #PR 
    pr_high_90 = rowSums(sapply(select(., contains("pr")), function(x) x > prec_high_90)),
    pr_low_10 = rowSums(sapply(select(., contains("pr")), function(x) x < prec_low_10)),
    pr_high_95 = rowSums(sapply(select(., contains("pr")), function(x) x > prec_high_95)),
    pr_low_5 = rowSums(sapply(select(., contains("pr")), function(x) x < prec_low_5)),
    pr_high_99 = rowSums(sapply(select(., contains("pr")), function(x) x > prec_high_99)),
    pr_low_1 = rowSums(sapply(select(., contains("pr")), function(x) x < prec_low_1)),
    pr_range = apply(select(., contains("pr")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    
    pr_mean = apply(select(., contains("pr")), 1, mean, na.rm = TRUE),
    pr_sd = apply(select(., contains("pr")), 1, sd, na.rm = TRUE),
    pr_median = apply(select(., contains("pr")), 1, median, na.rm = TRUE),
    pr_IQR = apply(select(., contains("pr")), 1, IQR, na.rm = TRUE),
    pr_last_months = rowMeans(select(., c("mean.201506_pr","mean.201507_pr", "mean.201508_pr"))),
    pr_first_months = rowMeans(select(., c("mean.201501_pr", "mean.201502_pr", "mean.201503_pr"))),
    pr_seasonal_diff = pr_last_months - pr_first_months,
    
    
    #tmmx
    tmax_high_90 = rowSums(sapply(select(., contains("tmmx")), function(x) x > tmax_high_90)),
    tmax_low_10 = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_low_10)),
    tmax_high_95 = rowSums(sapply(select(., contains("tmmx")), function(x) x > tmax_high_95)),
    tmax_low_5 = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_low_5)),
    tmax_high_99 = rowSums(sapply(select(., contains("tmmx")), function(x) x > tmax_high_99)),
    tmax_low_1 = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_low_1)),
    tmax_range = apply(select(., contains("tmmx")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMAX = rowMeans(.[,which(names(malnutrition_15)=="mean.201501_tmmx"):
                        which(names(malnutrition_15)=="mean.201512_tmmx")]),
    
    
    #tmmn
    tmin_high_90 = rowSums(sapply(select(., contains("tmmn")), function(x) x > tmin_high_90)),
    tmin_low_10 = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_low_10)),
    tmin_high_95 = rowSums(sapply(select(., contains("tmmn")), function(x) x > tmin_high_95)),
    tmin_low_5 = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_low_5)),
    tmin_high_99 = rowSums(sapply(select(., contains("tmmn")), function(x) x > tmin_high_99)),
    tmin_low_1 = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_low_1)),
    tmin_range = apply(select(., contains("tmmn")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMIN = rowMeans(.[,which(names(malnutrition_15)=="mean.201501_tmmn"):
                        which(names(malnutrition_15)=="mean.201512_tmmn")]))%>%
  ...
  transmute(HHID, area_residence, region, conglomerado, malnutrition, conglomerado,
            ...
            NDVI_high_90, NDVI_high_95, NDVI_high_99, NDVI_low_10, NDVI_low_5, NDVI_low_1,
            ...
            tmax_high_90, tmax_high_95, tmax_high_99, tmax_low_10, tmax_low_5, tmax_low_1,
            
            tmin_high_90, tmin_high_95, tmin_high_99, tmin_low_10, tmin_low_5, tmin_low_1,
...
cols_with_NDVI <- grep("NDVI", names(malnutrition_15_with_thresholds), value = TRUE)
cols_with_pr <- grep("pr$", names(malnutrition_15_with_thresholds), value = TRUE)
cols_with_tmmx <- grep("tmmx$", names(malnutrition_15_with_thresholds), value = TRUE)
cols_with_tmmn <- grep("tmmn$", names(malnutrition_15_with_thresholds), value = TRUE)
...
cols_veg_99 <- grep(paste0("veg_tr_", "99"), names(malnutrition_15_trans), value = TRUE)
cols_veg_95 <- grep(paste0("veg_tr_", "95"), names(malnutrition_15_trans), value = TRUE)
cols_veg_90 <- grep(paste0("veg_tr_", "90"), names(malnutrition_15_trans), value = TRUE)
cols_veg_1 <- grep("veg_tr_1_", names(malnutrition_15_trans), value = TRUE)
cols_veg_5 <- grep(paste0("veg_tr_", "5"), names(malnutrition_15_trans), value = TRUE)
cols_veg_10 <- grep(paste0("veg_tr_", "10"), names(malnutrition_15_trans), value = TRUE)

cols_prec_99 <- grep(paste0("prec_tr_", "99"), names(malnutrition_15_trans), value = TRUE)
cols_prec_95 <- grep(paste0("prec_tr_", "95"), names(malnutrition_15_trans), value = TRUE)
cols_prec_90 <- grep(paste0("prec_tr_", "90"), names(malnutrition_15_trans), value = TRUE)
cols_prec_1 <- grep("prec_tr_1_", names(malnutrition_15_trans), value = TRUE)
cols_prec_5 <- grep(paste0("prec_tr_", "5"), names(malnutrition_15_trans), value = TRUE)
cols_prec_10 <- grep(paste0("prec_tr_", "10"), names(malnutrition_15_trans), value = TRUE)

cols_tmax_99 <- grep(paste0("tmax_tr_", "99"), names(malnutrition_15_trans), value = TRUE)
cols_tmax_95 <- grep(paste0("tmax_tr_", "95"), names(malnutrition_15_trans), value = TRUE)
cols_tmax_90 <- grep(paste0("tmax_tr_", "90"), names(malnutrition_15_trans), value = TRUE)
cols_tmax_1 <- grep("tmax_tr_1_", names(malnutrition_15_trans), value = TRUE)
cols_tmax_5 <- grep(paste0("tmax_tr_", "5"), names(malnutrition_15_trans), value = TRUE)
cols_tmax_10 <- grep(paste0("tmax_tr_", "10"), names(malnutrition_15_trans), value = TRUE)

cols_tmin_99 <- grep(paste0("tmin_tr_", "99"), names(malnutrition_15_trans), value = TRUE)
cols_tmin_95 <- grep(paste0("tmin_tr_", "95"), names(malnutrition_15_trans), value = TRUE)
cols_tmin_90 <- grep(paste0("tmin_tr_", "90"), names(malnutrition_15_trans), value = TRUE)
cols_tmin_1 <- grep("tmin_tr_1_", names(malnutrition_15_trans), value = TRUE)
cols_tmin_5 <- grep(paste0("tmin_tr_", "5"), names(malnutrition_15_trans), value = TRUE)
cols_tmin_10 <- grep(paste0("tmin_tr_", "10"), names(malnutrition_15_trans), value = TRUE)

# Cummulative sum

malnutrition_15_new <- malnutrition_15_trans[, 80:length(names(malnutrition_15_trans))]
...
malnutrition_15_final <- malnutrition_15_new[, 289:length(names(malnutrition_15_new))]
...
malnutrition_16 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, region, 
            ...
            mean.24_NDVI, mean.25_NDVI, mean.26_NDVI,mean.27_NDVI, mean.28_NDVI, mean.29_NDVI, 
            mean.30_NDVI, mean.31_NDVI, mean.32_NDVI,mean.33_NDVI, mean.34_NDVI, mean.35_NDVI,
            
            mean.201601_pr,mean.201602_pr,mean.201603_pr,mean.201604_pr,mean.201605_pr,mean.201606_pr,
            mean.201607_pr,mean.201608_pr,mean.201609_pr,mean.201610_pr,mean.201611_pr,mean.201612_pr,
            
            mean.201601_tmmx,mean.201602_tmmx,mean.201603_tmmx,mean.201604_tmmx,mean.201605_tmmx,mean.201606_tmmx,
            mean.201607_tmmx,mean.201608_tmmx,mean.201609_tmmx,mean.201610_tmmx,mean.201611_tmmx,mean.201612_tmmx,
            
            mean.201601_tmmn,mean.201602_tmmn,mean.201603_tmmn,mean.201604_tmmn,mean.201605_tmmn,mean.201606_tmmn,
            mean.201607_tmmn,mean.201608_tmmn,mean.201609_tmmn,mean.201610_tmmn,mean.201611_tmmn,mean.201612_tmmn)
...
# Crear dataframe de umbrales por región
umbrales_region <- data.frame(region = 1:25,
                              veg_threshold_low = rep(0, 25),
                              veg_threshold_high = rep(0, 25),
                              prec_threshold_low = rep(0, 25),
                              prec_threshold_high = rep(0, 25),
                              tmax_threshold_low = rep(0, 25),
                              tmax_threshold_high = rep(0, 25),
                              tmin_threshold_low = rep(0, 25),
                              tmin_threshold_high = rep(0, 25))

# Calcular los umbrales para cada región
for (i in 1:25) {
  data_filtered <- malnutrition_final %>%
    filter(year == 2016, region == i)
  
  umbrales_region$veg_threshold_low[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", names(data_filtered))], 0.25, na.rm = TRUE)
  umbrales_region$veg_threshold_high[i] <- quantile(data_filtered[, grep("mean\\.\\d+_NDVI", names(data_filtered))], 0.75, na.rm =TRUE)
  
  umbrales_region$prec_threshold_low[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", names(data_filtered))], 0.25, na.rm =TRUE)
  umbrales_region$prec_threshold_high[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_pr", names(data_filtered))], 0.75, na.rm =TRUE)
  
  umbrales_region$tmax_threshold_low[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", names(data_filtered))], 0.25, na.rm =TRUE)
  umbrales_region$tmax_threshold_high[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmx", names(data_filtered))], 0.75, na.rm =TRUE)
  
  umbrales_region$tmin_threshold_low[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", names(data_filtered))], 0.25, na.rm =TRUE)
  umbrales_region$tmin_threshold_high[i] <- quantile(data_filtered[, grep("mean\\.\\d{6}_tmmn", names(data_filtered))], 0.75, na.rm =TRUE)
}


# Realizar merge con el dataframe "malnutrition_16"
malnutrition_16_with_thresholds <- malnutrition_16 %>%
  left_join(umbrales_region, by = "region")

malnutrition_16 <- malnutrition_16_with_thresholds %>%
  
  mutate(
    
    #NDVI
    NDVI_high_count = rowSums(sapply(select(., contains("NDVI")), function(x) x > veg_threshold_high)),
    NDVI_low_count = rowSums(sapply(select(., contains("NDVI")), function(x) x < veg_threshold_low)),
    NDVI_range = apply(select(., contains("NDVI")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    ...
    NDVI_median = apply(select(., contains("NDVI")), 1, median, na.rm = TRUE),
    NDVI_IQR = apply(select(., contains("NDVI")), 1, IQR, na.rm = TRUE),
    NDVI_last_months = rowMeans(select(., c("mean.29_NDVI", "mean.30_NDVI", "mean.31_NDVI"))),
    NDVI_first_months = rowMeans(select(., c("mean.24_NDVI", "mean.25_NDVI", "mean.26_NDVI"))),
    NDVI_seasonal_diff = NDVI_last_months - NDVI_first_months,
    
    
    #PR 
    pr_high_count = rowSums(sapply(select(., contains("pr")), function(x) x > prec_threshold_high)),
    pr_low_count = rowSums(sapply(select(., contains("pr")), function(x) x < prec_threshold_low)),
    pr_range = apply(select(., contains("pr")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    ...
    pr_median = apply(select(., contains("pr")), 1, median, na.rm = TRUE),
    pr_IQR = apply(select(., contains("pr")), 1, IQR, na.rm = TRUE),
    pr_last_months = rowMeans(select(., c("mean.201606_pr", "mean.201607_pr", "mean.201608_pr"))),
    pr_first_months = rowMeans(select(., c("mean.201601_pr", "mean.201602_pr", "mean.201603_pr"))),
    pr_seasonal_diff = pr_last_months - pr_first_months,
    
    
    #tmmx
    tmax_high_count = rowSums(sapply(select(., contains("tmmx")), function(x) x > tmax_threshold_high)),
    tmax_low_count = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_threshold_low)),
    tmax_range = apply(select(., contains("tmmx")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMAX = rowMeans(.[,which(names(malnutrition_16)=="mean.201601_tmmx"):
                        which(names(malnutrition_16)=="mean.201612_tmmx")]),
    
    
    #tmmn
    tmin_high_count = rowSums(sapply(select(., contains("tmmn")), function(x) x > tmin_threshold_high)),
    tmin_low_count = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_threshold_low)),
    tmin_range = apply(select(., contains("tmmn")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMIN = rowMeans(.[,which(names(malnutrition_16)=="mean.201601_tmmn"):
                        which(names(malnutrition_16)=="mean.201612_tmmn")]))%>%
  
  transmute(HHID, area_residence, region, malnutrition,
...
malnutrition_17 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, region, 
            ...
            mean.36_NDVI, mean.37_NDVI, mean.38_NDVI,mean.39_NDVI, mean.40_NDVI, mean.41_NDVI, 
            mean.42_NDVI, mean.43_NDVI, mean.44_NDVI,mean.45_NDVI, mean.46_NDVI, mean.47_NDVI,
            
            mean.201701_pr,mean.201702_pr,mean.201703_pr,mean.201704_pr,mean.201705_pr,mean.201706_pr,
            mean.201707_pr,mean.201708_pr,mean.201709_pr,mean.201710_pr,mean.201711_pr,mean.201712_pr,
            
            mean.201701_tmmx,mean.201702_tmmx,mean.201703_tmmx,mean.201704_tmmx,mean.201705_tmmx,mean.201706_tmmx,
            mean.201707_tmmx,mean.201708_tmmx,mean.201709_tmmx,mean.201710_tmmx,mean.201711_tmmx,mean.201712_tmmx,
            
            mean.201701_tmmn,mean.201702_tmmn,mean.201703_tmmn,mean.201704_tmmn,mean.201705_tmmn,mean.201706_tmmn,
            mean.201707_tmmn,mean.201708_tmmn,mean.201709_tmmn,mean.201710_tmmn,mean.201711_tmmn,mean.201712_tmmn)
...
# Realizar merge con el dataframe "malnutrition_17"
malnutrition_17_with_thresholds <- malnutrition_17 %>%
  left_join(umbrales_region, by = "region")

malnutrition_17 <- malnutrition_17_with_thresholds %>%
  ...
  mutate(
    ...
    NDVI_median = apply(select(., contains("NDVI")), 1, median, na.rm = TRUE),
    NDVI_IQR = apply(select(., contains("NDVI")), 1, IQR, na.rm = TRUE),
    NDVI_last_months = rowMeans(select(., c("mean.41_NDVI", "mean.42_NDVI", "mean.43_NDVI"))),
    NDVI_first_months = rowMeans(select(., c("mean.36_NDVI", "mean.37_NDVI", "mean.38_NDVI"))),
    NDVI_seasonal_diff = NDVI_last_months - NDVI_first_months,
    ...
    pr_median = apply(select(., contains("pr")), 1, median, na.rm = TRUE),
    pr_IQR = apply(select(., contains("pr")), 1, IQR, na.rm = TRUE),
    pr_last_months = rowMeans(select(., c("mean.201706_pr", "mean.201707_pr", "mean.201708_pr"))),
    pr_first_months = rowMeans(select(., c("mean.201701_pr", "mean.201702_pr", "mean.201703_pr"))),
    pr_seasonal_diff = pr_last_months - pr_first_months,
    ...
    tmax_low_count = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_threshold_low)),
    tmax_range = apply(select(., contains("tmmx")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMAX = rowMeans(.[,which(names(malnutrition_17)=="mean.201701_tmmx"):
                        which(names(malnutrition_17)=="mean.201712_tmmx")]),
    ...
    tmin_low_count = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_threshold_low)),
    tmin_range = apply(select(., contains("tmmn")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMIN = rowMeans(.[,which(names(malnutrition_17)=="mean.201701_tmmn"):
                        which(names(malnutrition_17)=="mean.201712_tmmn")]))%>%
...
malnutrition_18 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, region, 
            ...
            mean.48_NDVI, mean.49_NDVI, mean.50_NDVI,mean.51_NDVI, mean.52_NDVI, mean.53_NDVI, 
            mean.54_NDVI, mean.55_NDVI, mean.56_NDVI,mean.57_NDVI, mean.58_NDVI, mean.59_NDVI,
            
            mean.201801_pr,mean.201802_pr,mean.201803_pr,mean.201804_pr,mean.201805_pr,mean.201806_pr,
            mean.201807_pr,mean.201808_pr,mean.201809_pr,mean.201810_pr,mean.201811_pr,mean.201812_pr,
            
            mean.201801_tmmx,mean.201802_tmmx,mean.201803_tmmx,mean.201804_tmmx,mean.201805_tmmx,mean.201806_tmmx,
            mean.201807_tmmx,mean.201808_tmmx,mean.201809_tmmx,mean.201810_tmmx,mean.201811_tmmx,mean.201812_tmmx,
            
            mean.201801_tmmn,mean.201802_tmmn,mean.201803_tmmn,mean.201804_tmmn,mean.201805_tmmn,mean.201806_tmmn,
            mean.201807_tmmn,mean.201808_tmmn,mean.201809_tmmn,mean.201810_tmmn,mean.201811_tmmn,mean.201812_tmmn)
...
malnutrition_18 <- malnutrition_18_with_thresholds %>%
  ...
  mutate(
    ...
    NDVI_median = apply(select(., contains("NDVI")), 1, median, na.rm = TRUE),
    NDVI_IQR = apply(select(., contains("NDVI")), 1, IQR, na.rm = TRUE),
    NDVI_last_months = rowMeans(select(., c("mean.53_NDVI", "mean.54_NDVI", "mean.55_NDVI"))),
    NDVI_first_months = rowMeans(select(., c("mean.48_NDVI", "mean.49_NDVI", "mean.50_NDVI"))),
    NDVI_seasonal_diff = NDVI_last_months - NDVI_first_months,
    ...
    pr_median = apply(select(., contains("pr")), 1, median, na.rm = TRUE),
    pr_IQR = apply(select(., contains("pr")), 1, IQR, na.rm = TRUE),
    pr_last_months = rowMeans(select(., c("mean.201806_pr", "mean.201807_pr", "mean.201808_pr"))),
    pr_first_months = rowMeans(select(., c("mean.201801_pr", "mean.201802_pr", "mean.201803_pr"))),
    pr_seasonal_diff = pr_last_months - pr_first_months,
    ...
    tmax_low_count = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_threshold_low)),
    tmax_range = apply(select(., contains("tmmx")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMAX = rowMeans(.[,which(names(malnutrition_18)=="mean.201801_tmmx"):
                        which(names(malnutrition_18)=="mean.201812_tmmx")]),
    ...
    tmin_low_count = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_threshold_low)),
    tmin_range = apply(select(., contains("tmmn")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMIN = rowMeans(.[,which(names(malnutrition_18)=="mean.201801_tmmn"):
                        which(names(malnutrition_18)=="mean.201812_tmmn")]))%>%
...
malnutrition_19 <- malnutrition_final %>%
  ...
  transmute(HHID = HHID.x, malnutrition, longitudx, latitudy, area_residence, region, 
            ...
            mean.60_NDVI, mean.61_NDVI, mean.62_NDVI,mean.63_NDVI, mean.64_NDVI, mean.65_NDVI, 
            mean.66_NDVI, mean.67_NDVI, mean.68_NDVI,mean.69_NDVI, mean.70_NDVI, mean.71_NDVI,
            
            mean.201901_pr,mean.201902_pr,mean.201903_pr,mean.201904_pr,mean.201905_pr,mean.201906_pr,
            mean.201907_pr,mean.201908_pr,mean.201909_pr,mean.201910_pr,mean.201911_pr,mean.201912_pr,
            
            mean.201901_tmmx,mean.201902_tmmx,mean.201903_tmmx,mean.201904_tmmx,mean.201905_tmmx,mean.201906_tmmx,
            mean.201907_tmmx,mean.201908_tmmx,mean.201909_tmmx,mean.201910_tmmx,mean.201911_tmmx,mean.201912_tmmx,
            
            mean.201901_tmmn,mean.201902_tmmn,mean.201903_tmmn,mean.201904_tmmn,mean.201905_tmmn,mean.201906_tmmn,
            mean.201907_tmmn,mean.201908_tmmn,mean.201909_tmmn,mean.201910_tmmn,mean.201911_tmmn,mean.201912_tmmn)
...
malnutrition_19 <- malnutrition_19_with_thresholds %>%
  ...
  mutate(
    ...
    NDVI_median = apply(select(., contains("NDVI")), 1, median, na.rm = TRUE),
    NDVI_IQR = apply(select(., contains("NDVI")), 1, IQR, na.rm = TRUE),
    NDVI_last_months = rowMeans(select(., c("mean.65_NDVI", "mean.66_NDVI", "mean.67_NDVI"))),
    NDVI_first_months = rowMeans(select(., c("mean.60_NDVI", "mean.61_NDVI", "mean.62_NDVI"))),
    NDVI_seasonal_diff = NDVI_last_months - NDVI_first_months,
    ...
    pr_median = apply(select(., contains("pr")), 1, median, na.rm = TRUE),
    pr_IQR = apply(select(., contains("pr")), 1, IQR, na.rm = TRUE),
    pr_last_months = rowMeans(select(., c("mean.201906_pr", "mean.201907_pr", "mean.201908_pr"))),
    pr_first_months = rowMeans(select(., c("mean.201901_pr", "mean.201902_pr", "mean.201903_pr"))),
    pr_seasonal_diff = pr_last_months - pr_first_months,
    ...
    tmax_low_count = rowSums(sapply(select(., contains("tmmx")), function(x) x < tmax_threshold_low)),
    tmax_range = apply(select(., contains("tmmx")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMAX = rowMeans(.[,which(names(malnutrition_19)=="mean.201901_tmmx"):
                        which(names(malnutrition_19)=="mean.201912_tmmx")]),
    ...
    tmin_low_count = rowSums(sapply(select(., contains("tmmn")), function(x) x < tmin_threshold_low)),
    tmin_range = apply(select(., contains("tmmn")), 1, function(x) max(x, na.rm = TRUE) - min(x, na.rm = TRUE)),
    TMIN = rowMeans(.[,which(names(malnutrition_19)=="mean.201901_tmmn"):
                        which(names(malnutrition_19)=="mean.201912_tmmn")]))%>%
