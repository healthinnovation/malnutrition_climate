...
umbrales_region <- data.frame(conglomerado = unique(malnutrition_19$conglomerado),
                              veg_low_10 = rep(0, 767),
                              veg_low_5 = rep(0, 767),
                              veg_low_1 = rep(0, 767),
                              veg_high_90 = rep(0, 767),
                              veg_high_95 = rep(0, 767),
                              veg_high_99 = rep(0, 767),
                              prec_low_10 = rep(0, 767),
                              prec_low_5 = rep(0, 767),
                              prec_low_1 = rep(0, 767),
                              prec_high_90 = rep(0, 767),
                              prec_high_95 = rep(0, 767),
                              prec_high_99 = rep(0, 767),
                              tmax_low_10 = rep(0, 767),
                              tmax_low_5 = rep(0, 767),
                              tmax_low_1 = rep(0, 767),
                              tmax_high_90 = rep(0, 767),
                              tmax_high_95 = rep(0, 767),
                              tmax_high_99 = rep(0, 767),
                              tmin_low_10 = rep(0, 767),
                              tmin_low_5 = rep(0, 767),
                              tmin_low_1 = rep(0, 767),
                              tmin_high_90 = rep(0, 767),
                              tmin_high_95 = rep(0, 767),
                              tmin_high_99 = rep(0, 767))
